...
const moduleBuildOption = {
  entryPoints: [{ in: './src/js/index.tsx', out: './module/reactFoldCalendar' }],
...
const cssBuildOption = {
  entryPoints: [{ in: './src/css/calendar.css', out: './css/reactFoldCalendar' }],
  loader: { '.svg': 'dataurl' },
  banner: {
...
try {
  if (isDevMode()) {
    ...
    runDev({
      context: {
        ...moduleBuildOption,
        entryPoints: [...moduleBuildOption.entryPoints, { in: './src/css/calendar.css', out: 'css/reactFoldCalendar' }],
        loader: { '.svg': 'dataurl' },
    ...
    runDev({
      context: {
        ...browserBuildOption,
        entryPoints: [...browserBuildOption.entryPoints, { in: './src/css/calendar.css', out: 'css/reactFoldCalendar' }],
        loader: { '.svg': 'dataurl' },
        external: ['*.css'], // devserver/module - index.html에서 script type="module" 로 module.js로 갖고 오면서, format: 'esm'으로 빌드한 index.js에서 react를 정상적으로 가져오지 못하여 빌드 시 react, react-dom 번들되도록 함
      },
      serve: {
